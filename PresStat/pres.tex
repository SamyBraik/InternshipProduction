...
\begin{frame}{Comparison}
    ...
    \begin{tabular}{|c|c|c|}
        ...
        Normalizing flow & \makecell{Exact density estimation} & \makecell{Computationally intensive \\Less expressive} \\ 
        Flow matching & \makecell{Exact density estimation \\ Simulation free training \\Easy to sample}  & \makecell{}\\
